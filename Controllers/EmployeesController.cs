...
namespace Indocement_RESTFullAPI.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(IndocementDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PutEmployee(decimal id, Employee employee)
        {
            ...
            // Cek apakah EmployeeNo yang baru sudah ada untuk employee lain
            var existingEmployee = await _context.Employees
                .FirstOrDefaultAsync(e => e.EmployeeNo == employee.EmployeeNo && e.Id != id);

            if (existingEmployee != null)
            {
                return Conflict("Employee with the same EmployeeNo already exists.");
            }
        ...
        {
            // Cek apakah EmployeeNo sudah ada
            var existingEmployee = await _context.Employees
